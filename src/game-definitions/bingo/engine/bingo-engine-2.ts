...
const createInitialGameState = (
  ...
  // const lobbyState = gameSpecificInitialAction.gameSpecificAction.lobbyState;
  ...
  // const playerSeats = convertPlayerPoolToPlayerSeats(lobbyState.playerPool);
...
const applyBingoHostAction = async (
  ...
  console.log("APPLY BINGO HOST ACTION - GAME STATE", gameState);
  console.log("APPLY BINGO HOST ACTION - GAME ACTION", gameAction);
...
// export const BingoGameStateEngine: IBfgAllPublicKnowledgeGameEngine<
//   BingoGameState,
//   BingoPlayerAction,
//   BingoHostAction
// > = {
