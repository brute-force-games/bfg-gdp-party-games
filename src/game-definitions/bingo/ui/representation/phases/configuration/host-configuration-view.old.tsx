// import { Option, Stack, Typography, Card, FormControl, FormLabel, Select, FormHelperText, Slider, Switch, Button, Alert, Divider } from "@bfg-engine";
// import { GameHostComponentProps } from "@bfg-engine/models/game-engine/bfg-game-engine-types";
// import { useState, useEffect } from "react";
// import { BingoGameState, BingoHostAction, BingoGameConfiguration, BingoUpdateConfiguration, BINGO_GAME_TABLE_ACTION_UPDATE_CONFIGURATION, AUTO_CALL_INTERVAL_MIN, AUTO_CALL_INTERVAL_MAX } from "~/game-definitions/bingo/engine/bingo-engine-2";


// export const HostConfigurationView = (props: GameHostComponentProps<BingoGameState, BingoHostAction>) => {
//   const { gameState, actingAsPlayerSeat, onHostAction } = props;
...
//     if (!onHostAction || !actingAsPlayerSeat) {
